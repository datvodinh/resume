...
\resumeItemListStart[leftmargin=4pt,label={}]
  ...
  \resumeitem{\textbf{MLOps and Deployment}: {MLFlow, Kuberay, WandB, Dagster, Docker, Kubernetes, Helm, FluxCD.}} \\[-\baselineskip]
  \resumeitem{\textbf{Fullstack Development}: {FastAPI, Jinja, Gradio, NextJS, TailwindCSS, HTML, CSS.}} \\[-\baselineskip]
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeitem{Build a distributed and scalable data pipeline and orchestration using Dagster, capable of ingesting thousands of documents, images, and videos concurrently from S3 storage.}
        \resumeitem{Develop and serve a robust and autoscale model orchestration with Ray Serve and Kuberay on Kubernetes cluster, enabling seamless inference across multiple models to process data.}
        \resumeitem{Design and implement a vector retrieval search engine and GUI with FastAPI and Gradio, enhancing data retrieval with hybrid search and integrating visualization tools to display search results.}
